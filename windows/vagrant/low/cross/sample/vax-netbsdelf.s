...
# GNU C version 3.4.6 (vax-netbsdelf)
...
.LCFI14:
	subl2 $4,%sp
.LM30:
	addl3 4(%ap),8(%ap),%r0	# a, b, tmp25
.LM31:
	addl2 12(%ap),%r0	# c, <result>
	ret
.LFE16:
	.size	add3, .-add3
	.align 1
...
.LCFI23:
	...
	movl 4(%ap),%r0	# p, p
.LM51:
	movl $1,4(%r0)	#, <variable>.b
.LM52:
	movl 8(%r0),%r0	# <variable>.c, <result>
	ret
.LFE25:
	.size	member, .-member
.globl static_value
...
.LCFI25:
	subl2 $4,%sp
.LM56:
	movl static_value,%r0	# static_value, <result>
	ret
.LFE27:
...
.LCFI41:
	subl2 $4,%sp
.LM95:
	addl3 4(%ap),16(%ap),%r0	# a0, a3, tmp30
	addl2 24(%ap),%r0	# a5, tmp30
.LM96:
	addl2 32(%ap),%r0	# a7, <result>
	ret
.LFE38:
