...
@ options passed:  -nostdinc -D__ARM_ARCH_4T__ -D__USES_INITFINI__ -mthumb
@ -mthumb-interwork -auxbase-strip -g -O -Wall -fno-builtin -fverbose-asm
@ -fomit-frame-pointer
...
.LFB38:
	.loc 1 204 0
	.loc 1 205 0
	add	r3, r0, r3	@ tmp80, a0, a3
	ldr	r2, [sp, #4]	@ a5, a5
	add	r3, r3, r2	@ tmp80, tmp80, a5
	.loc 1 206 0
	ldr	r0, [sp, #12]	@ a7, a7
	add	r0, r3, r0	@ <result>, tmp80, a7
	@ sp needed for prologue	@
	bx	lr
.LFE38:
