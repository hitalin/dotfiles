	.file	"xscale-elf.c"
@ GNU C version 3.4.6 (xscale-elf)
@	compiled by GNU C version 4.2.1 20070719  [FreeBSD].
@ GGC heuristics: --param ggc-min-expand=65 --param ggc-min-heapsize=65536
@ options passed:  -nostdinc -D__ARM_ARCH_5TE__ -D__XSCALE__
@ -D__USES_INITFINI__ -auxbase-strip -g -O -Wall -fno-builtin -fverbose-asm
@ -fomit-frame-pointer
