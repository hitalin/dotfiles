...
High focus on GTD process workflow: ([[https://github.com/i0z0m/.references/blob/master/gtd-babel.org][source]])
#+RESULTS:
...
* Pretty
** Fonts
For fonts please download [[https://github.com/miiton/Cica][Cica]] and [[http://sourceforge.net/projects/dejavu/files/dejavu/2.37/dejavu-fonts-ttf-2.37.tar.bz2][DejaVu]]
